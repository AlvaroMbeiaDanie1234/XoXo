      ...
      <div className="max-w-[1128px] mx-auto flex justify-center gap-6 pt-6 px-4">
        ...
        <div className="flex-1 max-w-2xl w-full">
          <div className="bg-white border border-border rounded-md p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-foreground mb-4">Meus Ganhos</h2>
            <p className="text-muted-foreground">O seu saldo e histórico de ganhos aparecerão aqui.</p>
          </div>
        </div>
      </div>
    </div>
